...
contract SymPodConfiguratorTest is Test {
  ...
  function test_CanPauseCheckPoint() external {
    ...
    assertEq(podConfigurator.isCheckPointPaused(), true, "could not pause checkpoint");
  }
  ...
  function test_CanUnPauseCheckPoint() external {
    ...
    assertEq(podConfigurator.isCheckPointPaused(), false, "could not unpause checkpoint");
  }
  ...
  function test_CanPauseWithdrawals() external {
    ...
    assertEq(podConfigurator.isWithdrawalsPaused(), true, "could not pause withdrawals");
  }
  ...
  function test_CanUnPauseWithdrawal() external {
    ...
    assertEq(podConfigurator.isWithdrawalsPaused(), false, "could not unpause withdrawals");
  }
}
